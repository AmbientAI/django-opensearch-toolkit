...
class CreateProductsIndex(OpenSearchMigration):
    """Create the `products` index."""

    _KEY = "0002_create_products_index"
    _DESCRIPTION = "Create the products index"
    ...
    _CREATE_INDEX_REQUEST_BODY = {
        ...
        "mappings": {
            ...
            "dynamic_templates": [],
            "properties": {
                # NOTE: these are generated from Product._index.to_dict()
